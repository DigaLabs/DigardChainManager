    ...
    <>
      ...
      <div className='row g-5 g-xl-10 mb-5 mb-xl-10'>
        ...
        <div className='col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10'>
          {chainBalanceInformation && chainBalanceInformation.nativeCurrency && (
            <>
              <CardsWidget20
                className='h-md-50 mb-5 mb-xl-10'
                description={chainBalanceInformation.nativeCurrency.symbol}
                color='#F1416C'
                value={chainBalanceInformation.balance}
